// Ensure deprecated util.isArray usage from old dependencies doesn't emit warnings
// by replacing it with the modern Array.isArray before other modules load.
...
// server is started in main() after DB connection
